...
export default function MindDiffError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-[18px] font-semibold text-zinc-200">Couldn&apos;t compute Mind Diff</h1>
